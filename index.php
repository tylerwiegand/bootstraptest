<html lang="en">
	<head>
		...
		<link rel="javascript" type="text/js" href="js/bootstrap.js" />
		<title>Starship Wizard</title>
	</head>
	<body>
			<div class="container-fluid">
			<div class="row">
				<h1>About Steareihusahip</h1>
				<p class="layered-paper" id="text1" onclick="clickEvent1();">
				...
				<p class="layered-paper" id="text2" onclick="clickEvent2();">
